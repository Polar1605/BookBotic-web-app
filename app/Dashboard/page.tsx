//Page should Ideally be to show AI AGENT stats e.g number of calls made, sucessfully booked calls, unsucessfully booked calls (per day, per month) (maybe call logs)
